...
- container_crash_loop_backoff: Pod recommend-service-6495dd76cd-x4lsb is in CrashLoopBackOff state. Container exiting with code 1.
- pod_restart_count_increased: Pod has restarted 8 times. Restart count is abnormally high.
- pod_not_ready: Pod readiness probe failing. Pod recommend-service-6495dd76cd-x4lsb is not ready.
- deployment_metadata: Deployment recommend-service has 0/1 desired replicas ready. [DEGRADED]
